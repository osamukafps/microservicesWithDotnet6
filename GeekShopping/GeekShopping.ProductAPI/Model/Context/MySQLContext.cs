    ...
    public class MySQLContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Product>().HasData(new Product
            {
                ...
                Description = "Oh my God, we don't have internet!",
            ...
            {
                Id = 4,
                Name = "Capacete Darth Vader Black Series",
                Price = new decimal(899.90),
                Description = "Leia como se isso fosse uma descrição do produto",
            ...
            modelBuilder.Entity<Product>().HasData(new Product
            {
                ...
                CategoryName = "Sweatshirt".ToUpper()
            });
            modelBuilder.Entity<Product>().HasData(new Product
            {
                Id = 9,
            ...
            modelBuilder.Entity<Product>().HasData(new Product
            {
                ...
                CategoryName = "Action Figure".ToUpper()
            });
            modelBuilder.Entity<Product>().HasData(new Product
            {
                Id = 11,
