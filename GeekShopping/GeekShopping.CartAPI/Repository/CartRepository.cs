...
namespace GeekShopping.CartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<bool> ClearCart(string cartDetailsId)
        {
            var cartHeader = await _context.CartHeaders.FirstOrDefaultAsync(c => c.UserId == cartDetailsId);
            if (cartHeader != null)
            {
        ...
        public async Task<bool> RemoveCoupon(long userId)
        {
            throw new NotImplementedException();
        }
